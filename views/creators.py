    ...
    return Div(
        ...
        Div(
            ...
            P(
                ...
                title=f"${estimated_revenue:,}/month est.",
            ),
        ...
        Div(
            ...
            Div(
                ...
                A(
                    ...
                    "Compare",
                    href=(
                        f"/compare?a={compare_a_id}&b={creator_id}"
                        if compare_a_id and compare_a_id != creator_id
                        else f"/compare?a={creator_id}"
                    ),
                    id="compare-btn",
